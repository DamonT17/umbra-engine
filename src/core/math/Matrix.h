 ...
 *
 * @details A transformation matrix can perform arbitrary linear 3D transformations (i.e., translation, rotation,
 * scale, shear etc.) and perspective transformations using homogenous coordinates.
 */
template<typename T>
struct Matrix {
/******************************
 ...
 *****************************/
     ...
     * @return Matrix<T>
     *
     * @details Inverted matrix multiplied by original matrix should equal identity matrix. Matrices with a
     * determinant of 0 cannot be inverted. If the matrix is not invertible, Matrix<T>::zero() is returned.
     */
 ...
 *****************************/
     ...
     * @return Vector3<T>
     *
     * @details Returns the position of this matrix as a Vector3<T>. The position of a matrix is in the last row
     * (row major).
     */
 ...
 *****************************/
     ...
     * @return Matrix<T>
     *
     * @details Given an eye point, a target point, and an up vector, computes a transformation matrix that
     * corresponds to a camera viewing the target from the eye, such that the right-hand vector is perpendicular to
     * the up vector.
     */
