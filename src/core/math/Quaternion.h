 ...
 *****************************/
    ...
    /**
     * @brief Returns a quaternion that is the linear interpolation between a and b at t and normalizes the result.
    ...
    /**
     * @brief Returns a quaternion that is spherically interpolated between a and b at t. The parameter t is clamped
     * to the range [0, 1].
     * @param a The first quaternion. Returned when t = 0.
     * @param b The second quaternion. Returned when t = 1.
 ...
 *****************************/
     ...
     * @return bool
     *
     * @details Quaternions are considered not equal if the dot product of the two quaternions is not within 1e-5 of
     * 1.
     */
    bool operator!=(const Quaternion<T>& other) const;
