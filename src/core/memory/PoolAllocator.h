...
namespace UmbraEngine::Core::Memory {
     ...
     *
     * @details This class is a pool allocator. It allocates memory in fixed size blocks. When memory is allocated, a
     * block of the appropriate size is returned. When memory is deallocated, the block is returned to the pool.
     */
     ...
     */
        /**
         * @brief Creates a new pool allocator with the given block size, alignment, allocation size, and starting
         * address.
         */
